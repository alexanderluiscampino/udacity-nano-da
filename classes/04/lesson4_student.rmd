...
ggplot(aes(x = age, y = friend_count), data = pf) +
  ...
  geom_line(stat = 'summary', fun.y = quantile,
            linetype = 2, color = 'red', fun.args = list(probs = .1)) +
  geom_line(stat = 'summary', fun.y = quantile,
            linetype = 2, color = 'red', fun.args = list(probs = .9)) +
  geom_line(stat = 'summary', fun.y = quantile,
            color = 'red', fun.args = list(probs = .5))
...
head(pf[, c("age", "dob_month", "age_with_months")], 20)
```
...
pf.fc_by_age_months2 <- summarize(
            age_with_months_groups,
            friend_count_mean = mean(friend_count),
            friend_count_median = median (friend_count),
            n = n())
